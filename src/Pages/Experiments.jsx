...
const Experiments = () => {
  ...
  const handleStart = async (id) => {
    await updateExperimentStatus(id, 'in_progress');
          ...
          return (
            <div key={exp.id} className="bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition border border-gray-100">
              ...
              <div className="mt-3 flex gap-2">
                {status !== 'completed' && (
                  <button onClick={() => handleStart(exp.id)} className="flex-1 bg-blue-600 text-white py-2 rounded-lg text-sm hover:bg-blue-700 transition">
