...
const ExperimentPage = () => {
  ...
  if (loading) return <div className="p-8 text-center text-white min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700">Loading experiment...</div>;
  if (!experiment) return <div className="p-8 text-center text-red-300 min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700">Experiment not found.</div>;
  ...
  return (
    // Applied the Landing.jsx gradient background
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700">
      
      {/* Custom top bar - Glassmorphism theme */}
      <div className="bg-white/10 backdrop-blur-md border-b border-white/20 px-6 py-4 flex items-center gap-4 sticky top-0 z-50 shadow-lg">
        ...
        <div className="ml-auto">
          {/* Status badge adjusted for dark mode */}
