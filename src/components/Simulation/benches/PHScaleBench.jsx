      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center mt-2">
        ...
        <div className="flex justify-center items-end gap-8 md:gap-14 h-[240px] relative w-full max-w-4xl mb-16">
          ...
          <div className="flex flex-col items-center relative z-20 w-20">
            <div 
              className={`flex flex-col items-center transition-all duration-300 group cursor-pointer hover:-translate-y-2 hover:scale-105 hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] ${target === 'paper_stack' && animating ? 'scale-90 opacity-50' : ''}`}
              onClick={() => handleElementClick('paper_stack')}
            >
            ...
            <span className="absolute -bottom-16 text-[11px] font-bold text-white/90 px-4 py-1.5 bg-black/40 rounded-full border border-white/10 shadow-md whitespace-nowrap z-20 transition-colors duration-300 group-hover:bg-white/20">Paper Stack</span>
          </div>
          ...
          <div className="flex flex-col items-center relative z-20 w-24">
             <div 
              className={`absolute -top-32 flex flex-col items-center transition-all duration-500 group origin-bottom-right z-30 cursor-pointer hover:-translate-y-2 hover:scale-105 hover:drop-shadow-[0_0_15px_rgba(253,224,71,0.5)] ${target === 'lemon_drop' && animating ? '-translate-y-4 -rotate-[25deg]' : ''}`}
              onClick={() => handleElementClick('lemon_drop')}
            >
              <div className="w-5 h-6 bg-gray-800 rounded-t-xl" />
              <div className="w-7 h-2 bg-gray-900 rounded-sm" />
              <div className="w-10 h-12 bg-white/30 backdrop-blur-md rounded-b-lg border border-white/50 shadow-inner overflow-hidden relative transition-all duration-300 group-hover:border-yellow-300">
          ...
          <div className="flex flex-col items-center relative z-20 w-24">
             <div 
              className={`absolute -top-32 flex flex-col items-center transition-all duration-500 group origin-bottom-right z-30 cursor-pointer hover:-translate-y-2 hover:scale-105 hover:drop-shadow-[0_0_15px_rgba(103,232,249,0.5)] ${target === 'water_drop' && animating ? '-translate-y-4 -rotate-[25deg]' : ''}`}
              onClick={() => handleElementClick('water_drop')}
            >
              <div className="w-5 h-6 bg-gray-800 rounded-t-xl" />
              <div className="w-7 h-2 bg-gray-900 rounded-sm" />
              <div className="w-10 h-12 bg-white/30 backdrop-blur-md rounded-b-lg border border-white/50 shadow-inner overflow-hidden relative transition-all duration-300 group-hover:border-cyan-300">
          ...
          <div className="flex flex-col items-center relative z-20 w-24">
             <div 
              className={`absolute -top-32 flex flex-col items-center transition-all duration-500 group origin-bottom-right z-30 cursor-pointer hover:-translate-y-2 hover:scale-105 hover:drop-shadow-[0_0_15px_rgba(165,180,252,0.5)] ${target === 'ammonia_drop' && animating ? '-translate-y-4 -rotate-[25deg]' : ''}`}
              onClick={() => handleElementClick('ammonia_drop')}
            >
              <div className="w-5 h-6 bg-gray-800 rounded-t-xl" />
              <div className="w-7 h-2 bg-gray-900 rounded-sm" />
              <div className="w-10 h-12 bg-white/30 backdrop-blur-md rounded-b-lg border border-white/50 shadow-inner overflow-hidden relative transition-all duration-300 group-hover:border-indigo-300">
